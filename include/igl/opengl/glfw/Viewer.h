...
namespace glfw
{
  ...
  public:
    ...
    IGL_INLINE int launch     (bool fullscreen = false, const std::string &name = "Geometry Kit", int width = 0, int height = 0);
    IGL_INLINE int launch_init(bool fullscreen = false, const std::string &name = "Geometry Kit", int width = 0, int height = 0);
